...
the place at `0x07` names the kind of the walk of the files. The reference reads the walks of the first and of
...
it, the places of a key standing in four and thirty places of their own. The first key of a walk stands as the
word the reference names for the walk of the first kind, and the key of a walk of the third kind stands as the
word at `0x08` of the file, nine times over, three places beside it.

## The walk of the files of the first kind

Every file of the walk stands four places of a name, the places of the name, four places that name how many
places the file holds, and then the places of the file itself, so that the walk and the places of the files
stand one behind the other in the file. Every place of the walk stands under the walk of the keys, four places
...
places of the file stand, how many places they hold, the key those places stand under, and how many places the
name of the file stands in, with the name behind them. Every place of the walk stands under the key of the
walk, and every place of a name stands under one place of that key, the four places of the key standing over
...
key of the walk of the file, which begins again at the front of the file under the key the walk of the files
named for it.
...
- The walk of the first kind ends where the file ends, and a walk that stops in the middle of a file of the
  walk is turned away, where the reference would read the places behind the file as the places of the walk.
...
of the files of the first kind with the keys of its files, the walk of the files of the third kind, a file
