...
import { decipherHcaBlock } from "./hca-core.js";
...
/** The counts of the places of the picture of the engine (`Decode5Table1`). */
const DECODE5_TABLE1 = [
	Math.fround(0.08166019),
	Math.fround(0.08166019),
	Math.fround(0.08166019),
	Math.fround(0.08166019),
	Math.fround(0.08166019),
	...
	Math.fround(0.08166019),
	Math.fround(0.08166019),
	Math.fround(0.9807853),
	Math.fround(0.8314696),
	Math.fround(0.9807853),
	Math.fround(0.8314696),
	Math.fround(0.9807853),
	Math.fround(0.8314696),
	...
	Math.fround(0.9807853),
	Math.fround(0.8314696),
	Math.fround(0.9951847),
	Math.fround(0.9569404),
	Math.fround(0.8819213),
	Math.fround(0.7730104),
	Math.fround(0.9951847),
	Math.fround(0.9569404),
	Math.fround(0.8819213),
	Math.fround(0.7730104),
	...
	Math.fround(0.8819213),
	Math.fround(0.7730104),
	Math.fround(0.9987954),
	Math.fround(0.9891765),
	Math.fround(0.9700313),
	Math.fround(0.9415441),
	Math.fround(0.9039893),
	Math.fround(0.8577286),
	Math.fround(0.8032075),
	Math.fround(0.7409511),
	Math.fround(0.9987954),
	Math.fround(0.9891765),
	Math.fround(0.9700313),
	Math.fround(0.9415441),
	...
	Math.fround(0.8032075),
	Math.fround(0.7409511),
	Math.fround(0.9996988),
	Math.fround(0.9972904),
	Math.fround(0.9924796),
	Math.fround(0.9852777),
	Math.fround(0.9757021),
	Math.fround(0.9637761),
	Math.fround(0.9495282),
	Math.fround(0.9329928),
	Math.fround(0.9142098),
	Math.fround(0.8932243),
	Math.fround(0.870087),
	Math.fround(0.8448536),
	Math.fround(0.8175848),
	Math.fround(0.7883464),
	Math.fround(0.7572088),
	Math.fround(0.7242471),
	Math.fround(0.9996988),
	Math.fround(0.9972904),
	Math.fround(0.9924796),
	Math.fround(0.9852777),
	...
	Math.fround(0.7572088),
	Math.fround(0.7242471),
	Math.fround(0.9999247),
	Math.fround(0.9993224),
	Math.fround(0.9981181),
	Math.fround(0.9963126),
	Math.fround(0.993907),
	Math.fround(0.9909027),
	Math.fround(0.9873014),
	Math.fround(0.9831055),
	Math.fround(0.9783174),
	Math.fround(0.97294),
	Math.fround(0.9669765),
	Math.fround(0.9604305),
	Math.fround(0.953306),
	Math.fround(0.9456073),
	Math.fround(0.937339),
	Math.fround(0.9285061),
	Math.fround(0.9191139),
	Math.fround(0.909168),
	Math.fround(0.8986745),
	Math.fround(0.8876396),
	Math.fround(0.8760701),
	Math.fround(0.8639728),
	Math.fround(0.8513552),
	Math.fround(0.8382247),
	Math.fround(0.8245893),
	Math.fround(0.8104572),
	Math.fround(0.7958369),
	Math.fround(0.7807372),
	Math.fround(0.7651672),
	Math.fround(0.7491364),
	Math.fround(0.7326543),
	Math.fround(0.7157308),
	Math.fround(0.9999247),
	Math.fround(0.9993224),
	Math.fround(0.9981181),
	Math.fround(0.9963126),
	...
	Math.fround(0.7326543),
	Math.fround(0.7157308),
	Math.fround(0.9999812),
	Math.fround(0.9998306),
	Math.fround(0.9995294),
	Math.fround(0.9990777),
	Math.fround(0.9984756),
	Math.fround(0.997723),
	Math.fround(0.9968203),
	Math.fround(0.9957674),
	Math.fround(0.9945646),
	Math.fround(0.9932119),
	Math.fround(0.9917098),
	Math.fround(0.9900582),
	Math.fround(0.9882576),
	Math.fround(0.9863081),
	Math.fround(0.9842101),
	Math.fround(0.9819639),
	Math.fround(0.9795698),
	Math.fround(0.9770281),
	Math.fround(0.9743394),
	Math.fround(0.9715039),
	Math.fround(0.9685221),
	Math.fround(0.9653944),
	Math.fround(0.9621214),
	Math.fround(0.9587035),
	Math.fround(0.9551412),
	Math.fround(0.951435),
	Math.fround(0.9475856),
	Math.fround(0.9435934),
	Math.fround(0.9394592),
	Math.fround(0.9351835),
	Math.fround(0.9307669),
	Math.fround(0.9262102),
	Math.fround(0.921514),
	Math.fround(0.9166791),
	Math.fround(0.911706),
	Math.fround(0.9065957),
	Math.fround(0.9013488),
	Math.fround(0.8959662),
	Math.fround(0.8904487),
	Math.fround(0.8847971),
	Math.fround(0.8790122),
	Math.fround(0.873095),
	Math.fround(0.8670462),
	Math.fround(0.860867),
	Math.fround(0.854558),
	Math.fround(0.8481203),
	Math.fround(0.841555),
	Math.fround(0.8348629),
	Math.fround(0.8280451),
	Math.fround(0.8211025),
	Math.fround(0.8140363),
	Math.fround(0.8068476),
	Math.fround(0.7995372),
	Math.fround(0.7921066),
	Math.fround(0.7845566),
	Math.fround(0.7768885),
	Math.fround(0.7691033),
	Math.fround(0.7612024),
	Math.fround(0.7531868),
	Math.fround(0.7450578),
	Math.fround(0.7368166),
	Math.fround(0.7284644),
	Math.fround(0.7200025),
	Math.fround(0.7114322),
];

/** The counts of the places of the picture of the engine (`Decode5Table2`). */
const DECODE5_TABLE2 = [
	Math.fround(-0.03382476),
	Math.fround(0.03382476),
	Math.fround(0.03382476),
	Math.fround(-0.03382476),
	Math.fround(0.03382476),
	...
	Math.fround(0.03382476),
	Math.fround(-0.03382476),
	Math.fround(-0.1950903),
	Math.fround(-0.5555702),
	Math.fround(0.1950903),
	Math.fround(0.5555702),
	Math.fround(0.1950903),
	Math.fround(0.5555702),
	...
	Math.fround(0.1950903),
	Math.fround(0.5555702),
	Math.fround(-0.09801714),
	Math.fround(-0.2902847),
	Math.fround(-0.4713967),
	Math.fround(-0.6343933),
	Math.fround(0.09801714),
	Math.fround(0.2902847),
	Math.fround(0.4713967),
	Math.fround(0.6343933),
	...
	Math.fround(-0.4713967),
	Math.fround(-0.6343933),
	Math.fround(-0.04906768),
	Math.fround(-0.1467305),
	Math.fround(-0.2429802),
	Math.fround(-0.3368899),
	Math.fround(-0.4275551),
	Math.fround(-0.5141028),
	Math.fround(-0.5956993),
	Math.fround(-0.671559),
	Math.fround(0.04906768),
	Math.fround(0.1467305),
	Math.fround(0.2429802),
	Math.fround(0.3368899),
	...
	Math.fround(0.5956993),
	Math.fround(0.671559),
	Math.fround(-0.02454123),
	Math.fround(-0.07356457),
	Math.fround(-0.1224107),
	Math.fround(-0.1709619),
	Math.fround(-0.2191012),
	Math.fround(-0.2667128),
	Math.fround(-0.3136818),
	Math.fround(-0.3598951),
	Math.fround(-0.4052413),
	Math.fround(-0.4496113),
	Math.fround(-0.4928982),
	Math.fround(-0.5349976),
	Math.fround(-0.5758082),
	Math.fround(-0.6152316),
	Math.fround(-0.6531729),
	Math.fround(-0.6895406),
	Math.fround(0.02454123),
	Math.fround(0.07356457),
	Math.fround(0.1224107),
	Math.fround(0.1709619),
	...
	Math.fround(-0.6531729),
	Math.fround(-0.6895406),
	Math.fround(-0.01227154),
	Math.fround(-0.03680722),
	Math.fround(-0.06132074),
	Math.fround(-0.08579731),
	Math.fround(-0.1102222),
	Math.fround(-0.1345807),
	Math.fround(-0.1588582),
	Math.fround(-0.1830399),
	Math.fround(-0.2071114),
	Math.fround(-0.2310581),
	Math.fround(-0.2548656),
	Math.fround(-0.2785197),
	Math.fround(-0.3020059),
	Math.fround(-0.3253103),
	Math.fround(-0.3484187),
	Math.fround(-0.3713172),
	Math.fround(-0.393992),
	Math.fround(-0.4164295),
	Math.fround(-0.4386162),
	Math.fround(-0.4605387),
	Math.fround(-0.4821838),
	Math.fround(-0.5035384),
	Math.fround(-0.5245897),
	Math.fround(-0.545325),
	Math.fround(-0.5657318),
	Math.fround(-0.5857978),
	Math.fround(-0.6055111),
	Math.fround(-0.6248595),
	Math.fround(-0.6438316),
	Math.fround(-0.6624158),
	Math.fround(-0.680601),
	Math.fround(-0.6983762),
	Math.fround(0.01227154),
	Math.fround(0.03680722),
	Math.fround(0.06132074),
	Math.fround(0.08579731),
	...
	Math.fround(0.680601),
	Math.fround(0.6983762),
	Math.fround(-0.006135885),
	Math.fround(-0.01840673),
	Math.fround(-0.0306748),
	Math.fround(-0.04293826),
	Math.fround(-0.05519525),
	Math.fround(-0.06744392),
	Math.fround(-0.07968244),
	Math.fround(-0.09190895),
	Math.fround(-0.1041216),
	Math.fround(-0.1163186),
	Math.fround(-0.1284981),
	Math.fround(-0.1406582),
	Math.fround(-0.1527972),
	Math.fround(-0.1649131),
	Math.fround(-0.1770042),
	Math.fround(-0.1890687),
	Math.fround(-0.2011046),
	Math.fround(-0.2131103),
	Math.fround(-0.2250839),
	Math.fround(-0.2370236),
	Math.fround(-0.2489276),
	Math.fround(-0.2607941),
	Math.fround(-0.2726214),
	Math.fround(-0.2844075),
	Math.fround(-0.2961509),
	Math.fround(-0.3078496),
	Math.fround(-0.319502),
	Math.fround(-0.3311063),
	Math.fround(-0.3426607),
	Math.fround(-0.3541635),
	Math.fround(-0.365613),
	Math.fround(-0.3770074),
	Math.fround(-0.388345),
	Math.fround(-0.3996242),
	Math.fround(-0.4108432),
	Math.fround(-0.4220003),
	Math.fround(-0.4330938),
	Math.fround(-0.4441221),
	Math.fround(-0.4550836),
	Math.fround(-0.4659765),
	Math.fround(-0.4767992),
	Math.fround(-0.4875502),
	Math.fround(-0.4982277),
	Math.fround(-0.5088301),
	Math.fround(-0.519356),
	Math.fround(-0.5298036),
	Math.fround(-0.5401714),
	Math.fround(-0.550458),
	Math.fround(-0.5606616),
	Math.fround(-0.5707808),
	Math.fround(-0.5808139),
	Math.fround(-0.5907597),
	Math.fround(-0.6006165),
	Math.fround(-0.6103828),
	Math.fround(-0.6200572),
	Math.fround(-0.6296383),
	Math.fround(-0.6391245),
	Math.fround(-0.6485144),
	Math.fround(-0.6578067),
	Math.fround(-0.6669999),
	Math.fround(-0.6760927),
	Math.fround(-0.6850837),
	Math.fround(-0.6939715),
	Math.fround(-0.7027547),
];

/** The counts of the places of the picture of the engine (`Decode5Table3`). */
const DECODE5_TABLE3 = [
	Math.fround(0.0006905338),
	Math.fround(0.001976235),
	Math.fround(0.003673865),
	Math.fround(0.00572424),
	Math.fround(0.008096703),
	Math.fround(0.01077318),
	Math.fround(0.01374252),
	Math.fround(0.01699786),
	Math.fround(0.02053526),
	Math.fround(0.0243529),
	Math.fround(0.02845052),
	Math.fround(0.03282909),
	Math.fround(0.03749062),
	Math.fround(0.0424379),
	Math.fround(0.04767443),
	Math.fround(0.0532043),
	Math.fround(0.05903211),
	Math.fround(0.06516288),
	Math.fround(0.07160201),
	Math.fround(0.07835522),
	Math.fround(0.08542849),
	Math.fround(0.09282802),
	Math.fround(0.1005602),
	Math.fround(0.1086314),
	Math.fround(0.1170481),
	Math.fround(0.125817),
	Math.fround(0.1349443),
	Math.fround(0.1444365),
	Math.fround(0.1542995),
	Math.fround(0.1645391),
	Math.fround(0.1751607),
	Math.fround(0.1861692),
	Math.fround(0.1975687),
	Math.fround(0.209363),
	Math.fround(0.2215546),
	Math.fround(0.2341454),
	Math.fround(0.247136),
	Math.fround(0.2605258),
	Math.fround(0.2743127),
	Math.fround(0.2884932),
	Math.fround(0.3030619),
	Math.fround(0.3180117),
	Math.fround(0.3333333),
	Math.fround(0.3490153),
	Math.fround(0.3650438),
	Math.fround(0.3814027),
	Math.fround(0.3980731),
	Math.fround(0.4150335),
	Math.fround(0.4322598),
	Math.fround(0.449725),
	Math.fround(0.4673996),
	Math.fround(0.4852512),
	Math.fround(0.5032449),
	Math.fround(0.5213438),
	Math.fround(0.5395085),
	Math.fround(0.5576978),
	Math.fround(0.5758689),
	Math.fround(0.593978),
	Math.fround(0.6119806),
	Math.fround(0.6298314),
	Math.fround(0.647486),
	Math.fround(0.6649002),
	Math.fround(0.6820312),
	Math.fround(0.6988376),
	Math.fround(-0.7152804),
	Math.fround(-0.7313231),
	Math.fround(-0.7469321),
	Math.fround(-0.7620773),
	Math.fround(-0.7767318),
	Math.fround(-0.7908728),
	Math.fround(-0.8044813),
	Math.fround(-0.817542),
	Math.fround(-0.8300441),
	Math.fround(-0.8419802),
	Math.fround(-0.8533467),
	Math.fround(-0.8641438),
	Math.fround(-0.8743748),
	Math.fround(-0.8840462),
	Math.fround(-0.8931671),
	Math.fround(-0.9017491),
	Math.fround(-0.9098061),
	Math.fround(-0.9173537),
	Math.fround(-0.924409),
	Math.fround(-0.9309903),
	Math.fround(-0.937117),
	Math.fround(-0.942809),
	Math.fround(-0.9480868),
	Math.fround(-0.9529709),
	Math.fround(-0.9574819),
	Math.fround(-0.9616405),
	Math.fround(-0.9654669),
	Math.fround(-0.9689808),
	Math.fround(-0.9722016),
	Math.fround(-0.975148),
	Math.fround(-0.977838),
	Math.fround(-0.980289),
	Math.fround(-0.9825177),
	Math.fround(-0.9845399),
	Math.fround(-0.9863706),
	Math.fround(-0.9880241),
	Math.fround(-0.9895141),
	Math.fround(-0.9908532),
	Math.fround(-0.9920534),
	Math.fround(-0.9931263),
	Math.fround(-0.9940821),
	Math.fround(-0.994931),
	Math.fround(-0.9956822),
	Math.fround(-0.9963443),
	Math.fround(-0.9969255),
	Math.fround(-0.9974333),
	Math.fround(-0.9978746),
	Math.fround(-0.9982561),
	Math.fround(-0.9985837),
	Math.fround(-0.9988629),
	Math.fround(-0.9990991),
	Math.fround(-0.999297),
	Math.fround(-0.999461),
	Math.fround(-0.9995952),
	Math.fround(-0.9997034),
	Math.fround(-0.9997891),
	Math.fround(-0.9998555),
	Math.fround(-0.9999056),
	Math.fround(-0.9999419),
	Math.fround(-0.9999672),
	Math.fround(-0.9999836),
	Math.fround(-0.9999933),
	Math.fround(-0.999998),
	Math.fround(-0.9999998),
];
...
export class HcaChannel {
	...
	readonly sample1 = new Float32Array(VALUE_LIMIT);
	readonly sample2 = new Float32Array(VALUE_LIMIT);
	readonly sample3 = new Float32Array(VALUE_LIMIT);
	readonly samples = new Float32Array(BLOCK_SAMPLE_COUNT * 8);
	...
	/**
	 * The counts of the places of the picture of the engine of the engine itself (`Channel.Decode5`): the walk
	 * of the counts of the places of the picture of the engine over the counts of the places of the picture of
	 * the engine of a count of the places of the walk of the engine, of the counts of the places of the walk
	 * of the engine of the counts of them, and then the counts of the places of the picture of the engine of
	 * the count of the walk of the engine that stands behind them, which stand of the counts of the places of
	 * the picture of the engine of the count of the walk of the engine that stands in front of it.
	 */
	decode5(index: number): void {
		let src = this.block;
		let dst = this.sample1;
		for (let i = 0; i < 7; i += 1) {
			const count1 = 1 << i;
			const count2 = 0x40 >> i;
			let d1 = 0;
		...
		for (let i = 0; i < 7; i += 1) {
			...
			for (let j = 0; j < count1; j += 1) {
				for (let k = 0; k < count2; k += 1) {
					const a = src[s1++] ?? 0;
					const b = src[s2++] ?? 0;
					const c = DECODE5_TABLE1[i * 0x40 + l1++] ?? 0;
					const d = DECODE5_TABLE2[i * 0x40 + l2++] ?? 0;
					dst[d1++] = a * c - b * d;
					dst[d2--] = a * d + b * c;
				}
				s1 += count2;
		...
		let w = 0;
		for (let i = 0; i < BLOCK_SAMPLE_COUNT; i += 1)
			this.sample2[w++] = src[i] ?? 0;
		let s = 0;
		w = 0;
		let s1 = 0x40;
		let s2 = 0;
		const out = index * BLOCK_SAMPLE_COUNT;
		for (let i = 0; i < 0x40; i += 1)
			this.samples[out + w++] =
				(this.sample2[s1++] ?? 0) * (DECODE5_TABLE3[s++] ?? 0) +
				(this.sample3[s2++] ?? 0);
		for (let i = 0; i < 0x40; i += 1)
			this.samples[out + w++] =
				(DECODE5_TABLE3[s++] ?? 0) * (this.sample2[--s1] ?? 0) -
				(this.sample3[s2++] ?? 0);
		s1 = 0x3f;
		s2 = 0;
		for (let i = 0; i < 0x40; i += 1)
...
/** The counts of the places of a picture of the engine of a count of the places of a sound of the engine. */
const BLOCK_SAMPLE_COUNT = 0x80;

/** The counts of the places of a sound of the engine of one frame of the walk of the engine. */
export const HCA_SAMPLES_PER_FRAME = 8 * BLOCK_SAMPLE_COUNT;

/** The counts of the head of a sound of the engine the walk of the frames of it stands of. */
export interface HcaFrameLayout {
	dataOffset: number;
	blockCount: number;
	blockSize: number;
	channels: number;
...
/** The counts of the places of a sound of the engine of the count of the places of the sound of the engine. */
export function packHcaSample16(f: number): number {
	let s = Math.trunc(f * 0x7fff);
	if (s > 0x7fff) s = 0x7fff;
	else if (s < -0x7fff) s = -0x7fff;
	return s;
}

/** The counts of the frame before the last: the counts of the walk of the engine of the places of a sound. */
const FRAME_HEAD = 0xffff;

/**
 * The counts of the places of a sound of the engine (`HcaInput` over `HcaReader.DecodeBlock` and
 * `HcaReader.ConvertSequential`): every frame of the sound of the engine stands of the counts of the places
 * of a block of the walk of the engine, of the counts of the walk of the engine of the counts of them, and
 * then of the counts of the places of the picture of the engine of the engine itself, which stand of the
 * counts of the places of the sound of the engine.
 *
 * A frame of the engine of no counts of the walk of the engine at all stands of the counts of the places of
 * the frame that stands in front of it, as the reference stands of the counts of the walk of the engine of
 * the places of the picture of the engine of the frame that stands in front of it: the counts of the places
 * of the picture of the engine of a count of the walk of the engine stand of the counts of the walk of the
 * engine of the frame that stands in front of it themselves.
 */
export function decodeHcaFrames(
	data: Uint8Array,
	layout: HcaFrameLayout,
	ath: Uint8Array,
	cipher: Uint8Array,
): Buffer {
	const channels: HcaChannel[] = [];
	for (let at = 0; at < layout.channels; at += 1)
		channels.push(
			new HcaChannel(
				layout.channelMap[at] ?? 0,
				layout.r[5] ?? 0,
				layout.r[6] ?? 0,
			),
		);
	const r4 = layout.r[4] ?? 0;
	const r5 = layout.r[5] ?? 0;
	const r6 = layout.r[6] ?? 0;
	const r7 = layout.r[7] ?? 0;
	const out = Buffer.alloc(
		layout.blockCount * HCA_SAMPLES_PER_FRAME * layout.channels * 2,
	);
	let at = layout.dataOffset;
	let outAt = 0;
	for (let block = 0; block < layout.blockCount; block += 1) {
		if (at + layout.blockSize > data.length)
			throw invalidSound(
				"The frames of the sound of the engine stand behind it",
			);
		const frame = Buffer.from(data.subarray(at, at + layout.blockSize));
		at += layout.blockSize;
		// The places of a frame of the walk of the engine stand of the counts of the walk of the engine of
		// the places of the block itself: a block of the engine of the places of the counts of the walk of
		// the engine of its own stands of no sound of the engine at all.
		if (0 !== checkHcaBlock(frame))
			throw invalidSound(
				"The counts of the places of a block of the walk of the engine stand behind",
			);
		decipherHcaBlock(cipher, frame);
		const bits = new HcaBitStream(frame.subarray(0, layout.blockSize - 2));
		if (FRAME_HEAD === bits.getBits(16)) {
			const t = (bits.getBits(9) << 8) - bits.getBits(7);
			for (const channel of channels) channel.decode1(bits, layout.r9, t, ath);
			for (let index = 0; index < 8; index += 1) {
				for (const channel of channels) channel.decode2(bits);
				for (const channel of channels)
					channel.decode3(layout.r9, r7, r6 + r5, r4);
				for (let c = 0; c + 1 < channels.length; c += 1)
					channels[c]?.decode4(
						index,
						r4 - r5,
						r5,
						r6,
						channels[c + 1] as HcaChannel,
					);
				for (const channel of channels) channel.decode5(index);
			}
		}
		for (let j = 0; j < 8; j += 1) {
			for (let k = 0; k < BLOCK_SAMPLE_COUNT; k += 1) {
				for (let c = 0; c < layout.channels; c += 1) {
					const f = Math.fround(
						(channels[c]?.samples[j * BLOCK_SAMPLE_COUNT + k] ?? 0) *
							layout.rvaVolume,
					);
					out.writeInt16LE(packHcaSample16(f), outAt);
					outAt += 2;
				}
			}
		}
