...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			unsupported: [
				"image creation",
				"the three further packed walks - the 0x04 walk of the ways 0x04 and 0x06, the 0x05 walk of the ways 0x05 and 0x07, and the 0x0b walk of the ways 0x0a and 0x0b - which are refused by name",
			],
			remainingVerification: [
				"real-game GARbro differential output",
				"of the six ported ways, the later attempts' shapes of back reference and the retry between attempts, which no fixture here reaches: the ones the fixtures pin are the first attempt's byte form, a counted run, and the prediction table's own walk",
				"the three further packed walks, which no fixture here reaches because this port refuses them",
