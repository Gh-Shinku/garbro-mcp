...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			unsupported: [
				"image creation",
				"the eight further packed walks (0x01 to 0x0f), which are refused by name: each builds a sixty four thousand entry reference table first, and all of that code is decompiler output with nothing but the reference to check a transcription against",
			],
			remainingVerification: [
				"real-game GARbro differential output",
