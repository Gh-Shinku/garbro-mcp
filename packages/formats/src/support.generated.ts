...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			unsupported: [
				"archive creation",
				"the key of an archive read out of a start.ps3 beside it (FindArchiveKey): an archive that stands of it is refused",
				"CPZ1 and CPZ2 layouts, which stand of their own openers",
			],
			remainingVerification: [
				"real-game GARbro differential output",
				"an archive of a version above the fifth, of a key behind its index",
				"an archive whose key stands of a start.ps3",
			],
		},
	],
} as const;
