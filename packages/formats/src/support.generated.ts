...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			remainingVerification: [
				"real-game GARbro differential output",
				"the token that rebuilds the codes of the two tables out of the counts of the words (the word 272) and its two sorts, which the walk carries and no fixture reaches yet",
			],
		},
	],
} as const;
