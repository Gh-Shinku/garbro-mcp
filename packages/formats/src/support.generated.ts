...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			remainingVerification: [
				"real-game GARbro differential output",
				"the places of a sound of the walks of a picture of the engine beyond the places of the walk of the engine of the count of the walk of the sound of the counts of the walk of the engine of the count of no name at all (the walk of the counts of the gamma of the count of the walk of the engine stands of no count of the walk of the engine of the fixture)",
			],
		},
		{
			reference: {
