...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			remainingVerification: [
				"real-game GARbro differential output",
				"the places of a picture of the counts of the walk of the engine of the kind `RunlengthGamma` and of the kind `Nemesis` (the fixture stands of the counts of the walk of the engine of the kind `RunlengthHuffman` alone)",
