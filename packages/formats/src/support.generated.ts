...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			unsupported: [
				"sound creation",
				"the places of a sound of the kinds of the walks of a picture of the engine of two counts of a colour (`LOT_ERI_MSS`, of the walks of `MioDecoder.DecodeSoundDCT_MSS`)",
			...
			remainingVerification: [
				...
				"the places of a sound of the kinds of the walks of a picture of the engine of two counts of a colour (`LOT_ERI_MSS`)",
			],
		},
		{
			reference: {
