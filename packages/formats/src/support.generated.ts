...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			remainingVerification: [
				"real-game GARbro differential output",
				"the entry flag paths of the packed streams and of the ciphers of the engine itself, which the fixtures do not reach: the fixtures carry the walk of AES over an entry and the walk of RC6 over an index",
