	...
	implementations: [
		...
		},
		{
			...
			supported: [
				...
				"extract",
				"the three marks",
				"the two record sizes",
				"the stored index",
				"the packed index and the mixing of it",
				"the name folded record key",
				"the type the reference takes from the archive name",
			],
			unsupported: [
				"archive creation",
				"the GsData and ScW formats that share this source file, which are tracked as implementations of their own",
			],
			remainingVerification: [
				"real-game GARbro differential output",
				"a real archive whose index is packed, which exercises the LZSS walk over a real index",
				"a real archive of the encrypted kind, which exercises the key its record names fold into",
			],
		},
	],
} as const;
