...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			unsupported: [
				"image creation",
				"the six further packed walks (0x03 to 0x0f), which are refused by name: most build the reference table of sixty four thousand entries first, and all of that code is decompiler output with nothing but the reference to check a transcription against",
			],
			remainingVerification: [
				"real-game GARbro differential output",
				"of the three ported walks, the later attempts' shapes of back reference and the retry between attempts, which no fixture here reaches: one the fixture pins is the first attempt's byte form",
