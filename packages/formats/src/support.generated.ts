...
export const formatSupportCatalog = {
	...
	implementations: [
		...
		},
		{
			...
			remainingVerification: [
				"real-game GARbro differential output",
				"the runs of a block added to the block beside it or to the block two rows above it",
				"the places of the deepest kind of a picture, spread over the whole of a byte",
				"the drawing of a part of a picture over the picture it belongs to",
			],
		},
		{
			reference: {
